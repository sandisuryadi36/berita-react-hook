...
const Content = (props) => { 
    ...
    return (
        <div className="container my-2" id="content">
            ...
            {/* <Pagination page={state.propsData.page} totalResults={state.totalResults} changePage={changePage} /> */}
            ...
            {/* <Pagination page={state.propsData.page} totalResults={state.totalResults} /> */}
        </div>
    )
}
